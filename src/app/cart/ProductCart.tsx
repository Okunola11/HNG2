  ...
  return (
    <section className="w-full flex flex-col md:flex-row md:gap-7">
      ...
      <div className="w-full mt-8 md:mt-14">
        <div className="w-4/5 md:w-3/4 ml-10 md:ml-14 grid place-content-center gap-6">
          <div className="flex justify-between gap-6">
            <div className="flex flex-col gap-5">
              <p className="dark:text-[#EAEAEA] font-[300] text-base md:text-2xl text-[#6E6E6E]">
                RS34670
              </p>
              <p className="dark:text-[#EAEAEA] font-[600] text-2xl md:text-3xl text-[#0A0B0A]">
                Repair Scrub
              </p>
            </div>
            <div className="flex flex-col gap-5">
              ...
              <div>
                <p className="font-[400] text-xs md:text-sm text-[#797A7B] dark:text-[#EAEAEA]">
                  Unit Price
                </p>
                <p
          ...
          <p className="text-[#5A5A5A] dark:text-[#EAEAEA] text-sm">
          ...
          <div className="flex flex-col gap-6">
            <div>
              <div className="flex justify-between">
                <p className="text-base text-[#343434] dark:text-[#EAEAEA]">
                  How to use
                </p>
                <Image
          ...
          <div className="border-t border-[#EAEAEA] flex justify-between pt-2 md:mt-2 mb-4">
            <div>
              <button className="text-sm md:text-base text-[#363939] dark:text-[#EAEAEA] dark:border-[#EAEAEA] border border-[#363939] p-2 rounded-md">
                cancel
              </button>
            </div>
            <div>
              <p className="text-base md:text-lg text-[#797A7B] dark:text-[#EAEAEA]">
                Sub Total
              </p>
              <p
                className={`${inter.className} font-[600] text-lg md:text-xl text-[#363939] dark:text-[#EAEAEA]`}
              >
                $19.00
              </p>
            </div>
